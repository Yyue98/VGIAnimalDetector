...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ACStatusHUD/ACStatusHUD.framework"
  ...
  install_framework "${PODS_ROOT}/MapboxChinaPlugin/MapboxChinaPlugin.framework"
  install_dsym "${PODS_ROOT}/MapboxChinaPlugin/MapboxChinaPlugin.framework.dSYM"
  install_bcsymbolmap "${PODS_ROOT}/MapboxChinaPlugin/466AB085-A740-3A1C-A9BB-FFADD1B1FE9C.bcsymbolmap"
  install_bcsymbolmap "${PODS_ROOT}/MapboxChinaPlugin/A7EACCA5-9A4E-3EF9-B5FE-B716779BEA03.bcsymbolmap"
